 ...
 * y va da 0 a SCREEN_HEIGHT/2 - 1.
 * Il colore viene da game->ceiling_color (formato 0x00RRGGBB),
 * impostato dal parser leggendo la riga C nel file .cub. */
 ...
 * y va da SCREEN_HEIGHT/2 a SCREEN_HEIGHT - 1.
 * Il colore viene da game->floor_color (formato 0x00RRGGBB),
 * impostato dal parser leggendo la riga F nel file .cub. */
...
Chiamata all'inizio di ogni render, prima del raycasting,
cosi' i muri vengono disegnati sopra. */
