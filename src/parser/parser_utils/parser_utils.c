 ...
 * Necessario perche' ft_atoi("−1") restituisce -1 che supererebbe
 * il check rgb[i] < 0, ma ft_atoi("-1") con un trattino unicode o
 * caratteri nascosti passerebbe silenziosamente: meglio validare
 * carattere per carattere prima di convertire.
 ...
 * Usata per determinare l'altezza della mappa prima di allocare la griglia
 * e per controllare che ft_split abbia restituito esattamente 3 componenti
 * RGB. */
