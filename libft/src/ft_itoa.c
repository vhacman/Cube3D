...
significa che ogni cifra del numero puo’ essere estratta con l’operazione
...
cifra meno significativa alla piu’ significativa.
Poiche’ le stringhe in C sono memorizzate da sinistra a destra, l’array
